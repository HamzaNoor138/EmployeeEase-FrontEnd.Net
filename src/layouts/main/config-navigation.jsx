...
export const navConfig = [
  ...
  //         { title: 'VerifyV2', path: paths.authDemo.classic.verifyV2 },
  //         { title: 'Forgot Password v2', path: paths.authDemo.classic.forgotPassword2 },
  //         { title: 'Reset Password', path: paths.authDemo.classic.resetPassword },
  //         { title: 'Login (modern)', path: paths.authDemo.modern.login },
  //         { title: 'Register (modern)', path: paths.authDemo.modern.register },
  //         { title: 'Register Company', path: paths.authDemo.modern.registerCompany },
  //         {
