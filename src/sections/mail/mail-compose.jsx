...
export default function MailCompose({ onCloseCompose, onSubmit }) {
  const smUp = useResponsive('up', 'sm');

  const [reciepientEmail, setRecipient] = useState('');
  ...
  const handleChangeRecipient = useCallback((event) => {
  ...
  const handleSubmit = () => {
    onSubmit({ reciepientEmail, subject, body });
  };
